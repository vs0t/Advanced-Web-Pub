  ...
  var CourseList = React.createClass({
    render: function() {
      var courseNodes = this.props.data.map(function(course) {
        ...
        var mailtoLink = `mailto:evanaaronswood@gmail.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;
        ...
        return (
          <tr key={course.id}>
            ...
            <td><a href={mailtoLink} target="_blank">Email</a></td>
          </tr>
        );
      });
