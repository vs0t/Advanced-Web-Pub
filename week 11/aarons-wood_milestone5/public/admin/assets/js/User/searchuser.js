                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th>Address</th>
                            <td>
                                <input name="address" id="address" value={this.state.address} onChange={this.handleChange} />
                            </td>
                        </tr>
                        <tr>
                            <th>City</th>
                            <td>
                                <input name="city" id="city" value={this.state.city} onChange={this.handleChange} />
                            </td>
                        </tr>
                        <tr>
                            <th>State</th>
                        ...
                        <tr>
                            <th>Zip</th>
                            <td>
                                <input name="zip" id="zip" value={this.state.zip} onChange={this.handleChange} />
                            </td>
                        </tr>
                        <tr>
                            <th>Email</th>
                            <td>
                                <input name="email" id="email" value={this.state.email} onChange={this.handleChange} />
                            </td>
                        </tr>
                        <tr>
                            <th>Category</th>
                            <td>
                                <SelectList data={this.state.categoryData} onChange={this.handleCategoryChange} />
                            </td>
                        </tr>
                        <tr>
                            <th>Role</th>
                            <td>
                                <SelectList2 data={this.state.roleData} onRoleChange={this.handleRoleChange} />
                            </td>
                        </tr>
                    </tbody>
                </table>
      ...
      var userNodes = this.props.data.map(function (user) {
        return (
          <User
            ...
            category={user.CatagoryID} // Ensure to convert ID to name if necessary
            role={user.RoleID} // Ensure to convert ID to name if necessary
          />
        );
      });
    ...
    render: function () {
      return (
        <tr>
          ...
          <td>{this.props.category}</td> {/* Make sure this prop is passed correctly */}
          <td>{this.props.role}</td> {/* Make sure this prop is passed correctly */}
        </tr>
      );
    }
  });
