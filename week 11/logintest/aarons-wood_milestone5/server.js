...
app.post("/insertproduct", function (req, res) {
  ...
  con.query(sqlEA, function (err, result) {
    ...
    res.send({ message: "Product Inserted Successfully!", success: true, productId: result.insertId }); // Respond with success and the ID of the inserted product
  });
});
...
app.post("/insertinventory", function (req, res) {
  ...
  con.query(sqlEA, function (err, result) {
    ...
    res.send({ message: "Inventory Inserted", success: true, inventoryId: result.insertId });
  });
});
